...
<dsl-rim:namespaceMappings xmlns:dsl-rim="http://www.decisionsoft.com/rim" xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse">
    ...
    <dsl-rim:namespaceMapping prefix="fps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/15-16/1"/>
...
<!--PATTERN p18-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:EmpRefs/fps:ECON" mode="M8" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="substring('ABCDEFHJKLMNPQRTWXY', (((8 * substring((.), 2, 1)) + (7 * substring((.), 3, 1)) + (6 * substring((.), 4, 1)) + (5 * substring((.), 5, 1)) + (4 * substring((.), 6, 1)) + (3 * substring((.), 7, 1)) + (2 * substring((.), 8, 1)) + 37) mod 19) + 1, 1) = substring((.), 9, 1)"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7859</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The ECON must be valid against the Modulus 19 Check. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>Must be valid against the Modulus 19 Check</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p19-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:EmpRefs/fps:SAUTR" mode="M9" priority="4000">
...
<!--PATTERN p20-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:EmpRefs/fps:COTAXRef" mode="M10" priority="4000">
...
<!--PATTERN p21-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:RelatedTaxYear" mode="M11" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="substring(string(2016 - 1), 3, 2) = substring(., 1, 2)           and             substring(2016, 3, 2) = substring(., 4, 2)"/>
      <axsl:otherwise>
        ...
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>Must be the appropriate tax year for the schema year. I.E. 15-16 for RTI-2016</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p24-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:EmployeeDetails/fps:Address/fps:ForeignCountry" mode="M12" priority="4000">
...
<!--PATTERN p25-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:EmployeeDetails/fps:BirthDate" mode="M13" priority="4000">
...
<!--PATTERN p26-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:EmployeeDetails/fps:PartnerDetails" mode="M14" priority="4000">
...
<!--PATTERN p23-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:EmployeeDetails" mode="M15" priority="4000">
...
<!--PATTERN p28-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:TaxWkOfApptOfDirector" mode="M16" priority="4000">
...
<!--PATTERN p29-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Starter/fps:StartDate" mode="M17" priority="4000">
...
<!--PATTERN p30-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Starter/fps:Seconded/fps:EEACitizen" mode="M18" priority="4000">
...
<!--PATTERN p33-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Payment/fps:SMPYTD" mode="M21" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="../../../fps:EmployeeDetails/fps:Gender = 'F'"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7848</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">There is an entry in [STATUTORYMATERNITYPAY]. This can only be present if [GENDER] equals F. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>If [STATUTORYMATERNITYPAY] is present the following should be true: [GENDER] equals F</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p34-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Payment/fps:TrivialCommutationPayment" mode="M22" priority="4000">
...
<!--PATTERN p35-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:NIletter" mode="M23" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not (../../../fps:EmployeeDetails/fps:Gender = 'M')               or               not ( (. = 'B') or (. = 'E') or (. = 'O') or (. = 'T') )"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7849</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The NI Letter cannot be B, E, O or T if [GENDER] is shown as male. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>If [GENDER] is male, NI Letter cannot contain B, E, O or T</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<axsl:choose>
      ...
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="../fps:SCON             or               not(. = 'D' or . = 'E' or . = 'I' or . = 'K' or . = 'L' or . = 'N' or . = 'O' or . = 'V')"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7914</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">There must be an entry in [SCON] if [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'. If you do not know the relevant SCON you can find it on your Employer's Contracting-out Certificate or by contacting your Pension Scheme Provider.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>[SCON] is mandatory if [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'.</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p36-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:SCON" mode="M24" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="substring('ABCDEFHJKLMNPQRTWXY', (((8 * substring((.), 2, 1)) + (7 * substring((.), 3, 1)) + (6 * substring((.), 4, 1)) + (5 * substring((.), 5, 1)) + (4 * substring((.), 6, 1)) + (3 * substring((.), 7, 1)) + (2 * substring((.), 8, 1)) + 51) mod 19) + 1, 1) = substring((.), 9, 1)"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7887</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The SCON entered must be valid against the Modulus 19 Check. If you don't know your SCON you can find it on your Employer's Contracting-out certificate or by contacting your Pension Scheme Provider.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not(. = 'S2769999P')"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7930</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The entry in [SCON] of 'S2769999P' is not an acceptable entry. Please enter the correct SCON. If you don't know your SCON you can find it on your Employer's Contracting-out certificate or by contacting your Pension Scheme Provider.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>[SCON] is valid only if this does not equal 'S2769999P'</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p37-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:AtLELYTD" mode="M25" priority="4000">
...
<!--PATTERN p38-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:LELtoPTYTD" mode="M26" priority="4000">
...
<!--PATTERN p39-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:PTtoUAPYTD" mode="M27" priority="4000">
...
<axsl:choose>
      ...
      <axsl:otherwise>
        ...
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The amount in [Earnings above PT to UAP] must be 0.00 if the [NILETTER] is 'X'. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>[Earnings above PT to UAP] must be zero if [NILETTER] is 'X'</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p40-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:UAPtoUELYTD" mode="M28" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not (../fps:NIletter = 'X')             or               . = 0"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7855</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The amount in [Earnings above UAP up to UEL] must be 0.00 if the [NILETTER] is 'X'. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>[Earnings above UAP up to UEL] must be zero if [NILETTER] is 'X'</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p41-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:TotalEmpNICInPd" mode="M29" priority="4000">
...
<!--PATTERN p42-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:TotalEmpNICYTD" mode="M30" priority="4000">
...
<!--PATTERN p43-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:EmpeeContribnsInPd" mode="M31" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not(../fps:NIletter = 'X' or ../fps:NIletter = 'C' or ../fps:NIletter = 'W') or . = 0"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7865</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The amount in [EMPLOYEESCONTRIBUTIONSONALLEARNINGS] must be 0.00 if the [NILETTER] is 'X', 'C', or 'W'. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>This must be 0.00 if [NILETTER] is 'X', 'C', or 'W'.</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p44-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:EmpeeContribnsYTD" mode="M32" priority="4000">
...
<axsl:choose>
      ...
      <axsl:otherwise>
        ...
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">The amount in [EMPLOYEESCONTRIBUTIONSONALLEARNINGSYEARTODATE] must be 0.00 if the [NILETTER] is 'X', 'C', or 'W'. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
...
<!--PATTERN p27-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment" mode="M33" priority="4000">
...
<!--PATTERN p22-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee" mode="M34" priority="4000">
...
<!--PATTERN p45-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:FinalSubmission/fps:BecauseSchemeCeased" mode="M35" priority="4000">
...
<!--PATTERN p46-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:FinalSubmission/fps:DateSchemeCeased" mode="M36" priority="4000">
...
<!--PATTERN p15-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission" mode="M37" priority="4000">
...
<axsl:choose>
      ...
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="fps:Employee             or           fps:CompressedPart             or           fps:FinalSubmission             or           fps:QuestionsAndDeclarations"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7877</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">At least one of [EMPLOYEE], [COMPRESSEDPART], [FINALSUBMISSION] or [QUESTIONSANDDECLARATIONS] must be submitted</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>At least one of [EMPLOYEE], [COMPRESSEDPART], [FINALSUBMISSION] or [QUESTIONSANDDECLARATIONS] must be submitted</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="fps:EmpRefs/fps:ECON         or           count(fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:NIletter[(. = 'D') or (. = 'E') or (. = 'I') or (. = 'K') or (. = 'L') or (. = 'N') or (. = 'O') or (. = 'V')]) = 0"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7908</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">There must be an entry in [ECON] if any [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'. Please check</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>[ECON] is mandatory if any [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'.</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
