...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="exslt">
  ...
  <sch:ns prefix="fps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/FullPaymentSubmission/15-16/1"/>
    <sch:pattern id="p14">
    ...
    <sch:pattern id="p18">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:EmpRefs/fps:ECON">
        <sch:assert test="substring(&apos;ABCDEFHJKLMNPQRTWXY&apos;, (((8 * substring((.), 2, 1)) + (7 * substring((.), 3, 1)) + (6 * substring((.), 4, 1)) + (5 * substring((.), 5, 1)) + (4 * substring((.), 6, 1)) + (3 * substring((.), 7, 1)) + (2 * substring((.), 8, 1)) + 37) mod 19) + 1, 1) = substring((.), 9, 1)" id="a_ECON.1" diagnostics="errorCode.ECON.1 transactional.ECON.1 transactional.en.ECON.1 ">Must be valid against the Modulus 19 Check</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p19">
    ...
    <sch:pattern id="p21">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:RelatedTaxYear">
        <sch:assert test="substring(string(2016 - 1), 3, 2) = substring(., 1, 2)
          and
            substring(2016, 3, 2) = substring(., 4, 2)" id="a_RELATEDTAXYEAR.0" diagnostics="errorCode.RELATEDTAXYEAR.0 transactional.RELATEDTAXYEAR.0 transactional.en.RELATEDTAXYEAR.0 ">Must be the appropriate tax year for the schema year. I.E. 15-16 for RTI-2016</sch:assert>
    ...
    <sch:pattern id="p33">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:Payment/fps:SMPYTD">
        <sch:assert test="../../../fps:EmployeeDetails/fps:Gender = &apos;F&apos;" id="a_STATUTORYMATERNITYPAY.0" diagnostics="errorCode.STATUTORYMATERNITYPAY.0 transactional.STATUTORYMATERNITYPAY.0 transactional.en.STATUTORYMATERNITYPAY.0 ">If [STATUTORYMATERNITYPAY] is present the following should be true: [GENDER] equals F</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p34">
    ...
    <sch:pattern id="p35">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:NIletter">
        <sch:assert test="not (../../../fps:EmployeeDetails/fps:Gender = &apos;M&apos;)
              or
              not ( (. = &apos;B&apos;) or (. = &apos;E&apos;) or (. = &apos;O&apos;) or (. = &apos;T&apos;) )" id="a_NILETTER.0" diagnostics="errorCode.NILETTER.0 transactional.NILETTER.0 transactional.en.NILETTER.0 ">If [GENDER] is male, NI Letter cannot contain B, E, O or T</sch:assert>
        ...
        <sch:assert test="../fps:SCON
            or
              not(. = &apos;D&apos; or . = &apos;E&apos; or . = &apos;I&apos; or . = &apos;K&apos; or . = &apos;L&apos; or . = &apos;N&apos; or . = &apos;O&apos; or . = &apos;V&apos;)" id="a_NILETTER.2" diagnostics="errorCode.NILETTER.2 transactional.NILETTER.2 transactional.en.NILETTER.2 ">[SCON] is mandatory if [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'.</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p36">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:SCON">
        <sch:assert test="substring(&apos;ABCDEFHJKLMNPQRTWXY&apos;, (((8 * substring((.), 2, 1)) + (7 * substring((.), 3, 1)) + (6 * substring((.), 4, 1)) + (5 * substring((.), 5, 1)) + (4 * substring((.), 6, 1)) + (3 * substring((.), 7, 1)) + (2 * substring((.), 8, 1)) + 51) mod 19) + 1, 1) = substring((.), 9, 1)" id="a_SCON.0" diagnostics="errorCode.SCON.0 transactional.SCON.0 transactional.en.SCON.0 ">Must be valid against the Modulus 19 Check</sch:assert>
        <sch:assert test="not(. = &apos;S2769999P&apos;)" id="a_SCON.1" diagnostics="errorCode.SCON.1 transactional.SCON.1 transactional.en.SCON.1 ">[SCON] is valid only if this does not equal 'S2769999P'</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p37">
    ...
    <sch:pattern id="p39">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:PTtoUAPYTD">
        <sch:assert test="not (../fps:NIletter = &apos;X&apos;)
            or
              . = 0" id="a_PT-TO-UAP.1" diagnostics="errorCode.PT-TO-UAP.1 transactional.PT-TO-UAP.1 transactional.en.PT-TO-UAP.1 ">[Earnings above PT to UAP] must be zero if [NILETTER] is 'X'</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p40">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission/fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:UAPtoUELYTD">
        <sch:assert test="not (../fps:NIletter = &apos;X&apos;)
            or
              . = 0" id="a_UAP-TO-UEL.1" diagnostics="errorCode.UAP-TO-UEL.1 transactional.UAP-TO-UEL.1 transactional.en.UAP-TO-UEL.1 ">[Earnings above UAP up to UEL] must be zero if [NILETTER] is 'X'</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p41">
    ...
    <sch:pattern id="p15">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/fps:IRenvelope/fps:FullPaymentSubmission">
        ...
        <sch:assert test="fps:Employee
          ...
          fps:FinalSubmission
            or
          fps:QuestionsAndDeclarations" id="a_FPS.1" diagnostics="errorCode.FPS.1 transactional.FPS.1 transactional.en.FPS.1 ">At least one of [EMPLOYEE], [COMPRESSEDPART], [FINALSUBMISSION] or [QUESTIONSANDDECLARATIONS] must be submitted</sch:assert>
        <sch:assert test="fps:EmpRefs/fps:ECON
        or
          count(fps:Employee/fps:Employment/fps:NIlettersAndValues/fps:NIletter[(. = &apos;D&apos;) or (. = &apos;E&apos;) or (. = &apos;I&apos;) or (. = &apos;K&apos;) or (. = &apos;L&apos;) or (. = &apos;N&apos;) or (. = &apos;O&apos;) or (. = &apos;V&apos;)]) = 0" id="a_FINALSUBMISSION.0" diagnostics="errorCode.FINALSUBMISSION.0 transactional.FINALSUBMISSION.0 transactional.en.FINALSUBMISSION.0 ">[ECON] is mandatory if any [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'.</sch:assert>
      </sch:rule>
    </sch:pattern>
  <sch:diagnostics>
    ...
    <sch:diagnostic id="transactional.FPS.1">At least one of [EMPLOYEE], [COMPRESSEDPART], [FINALSUBMISSION] or [QUESTIONSANDDECLARATIONS] must be submitted</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FPS.1">At least one of [EMPLOYEE], [COMPRESSEDPART], [FINALSUBMISSION] or [QUESTIONSANDDECLARATIONS] must be submitted</sch:diagnostic>
    <sch:diagnostic id="errorCode.FINALSUBMISSION.0">7908</sch:diagnostic>
    <sch:diagnostic id="transactional.FINALSUBMISSION.0">There must be an entry in [ECON] if any [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'. Please check</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.FINALSUBMISSION.0">There must be an entry in [ECON] if any [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'. Please check</sch:diagnostic>
    ...
    <sch:diagnostic id="errorCode.ECON.1">7859</sch:diagnostic>
    <sch:diagnostic id="transactional.ECON.1">The ECON must be valid against the Modulus 19 Check. Please check</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.ECON.1">The ECON must be valid against the Modulus 19 Check. Please check</sch:diagnostic>
    ...
    <sch:diagnostic xml:lang="en" id="transactional.en.STATUTORYMATERNITYPAY.0">There is an entry in [STATUTORYMATERNITYPAY]. This can only be present if [GENDER] equals F. Please check</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.NILETTER.0">The NI Letter cannot be B, E, O or T if [GENDER] is shown as male. Please check</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.NILETTER.0">The NI Letter cannot be B, E, O or T if [GENDER] is shown as male. Please check</sch:diagnostic>
    ...
    <sch:diagnostic id="errorCode.NILETTER.2">7914</sch:diagnostic>
    <sch:diagnostic id="transactional.NILETTER.2">There must be an entry in [SCON] if [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'. If you do not know the relevant SCON you can find it on your Employer's Contracting-out Certificate or by contacting your Pension Scheme Provider.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.NILETTER.2">There must be an entry in [SCON] if [NILETTER] is one of 'D', 'E', 'I', 'K', 'L', 'N', 'O' or 'V'. If you do not know the relevant SCON you can find it on your Employer's Contracting-out Certificate or by contacting your Pension Scheme Provider.</sch:diagnostic>
    <sch:diagnostic id="errorCode.SCON.0">7887</sch:diagnostic>
    <sch:diagnostic id="transactional.SCON.0">The SCON entered must be valid against the Modulus 19 Check. If you don't know your SCON you can find it on your Employer's Contracting-out certificate or by contacting your Pension Scheme Provider.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SCON.0">The SCON entered must be valid against the Modulus 19 Check. If you don't know your SCON you can find it on your Employer's Contracting-out certificate or by contacting your Pension Scheme Provider.</sch:diagnostic>
    <sch:diagnostic id="errorCode.SCON.1">7930</sch:diagnostic>
    <sch:diagnostic id="transactional.SCON.1">The entry in [SCON] of 'S2769999P' is not an acceptable entry. Please enter the correct SCON. If you don't know your SCON you can find it on your Employer's Contracting-out certificate or by contacting your Pension Scheme Provider.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.SCON.1">The entry in [SCON] of 'S2769999P' is not an acceptable entry. Please enter the correct SCON. If you don't know your SCON you can find it on your Employer's Contracting-out certificate or by contacting your Pension Scheme Provider.</sch:diagnostic>
    ...
    <sch:diagnostic id="errorCode.PT-TO-UAP.1">7854</sch:diagnostic>
    <sch:diagnostic id="transactional.PT-TO-UAP.1">The amount in [Earnings above PT to UAP] must be 0.00 if the [NILETTER] is 'X'. Please check</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.PT-TO-UAP.1">The amount in [Earnings above PT to UAP] must be 0.00 if the [NILETTER] is 'X'. Please check</sch:diagnostic>
    <sch:diagnostic id="errorCode.UAP-TO-UEL.1">7855</sch:diagnostic>
    <sch:diagnostic id="transactional.UAP-TO-UEL.1">The amount in [Earnings above UAP up to UEL] must be 0.00 if the [NILETTER] is 'X'. Please check</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.UAP-TO-UEL.1">The amount in [Earnings above UAP up to UEL] must be 0.00 if the [NILETTER] is 'X'. Please check</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.EMPLOYEESCONTRIBUTIONSONALLEARNINGS.1">The amount in [EMPLOYEESCONTRIBUTIONSONALLEARNINGS] must be 0.00 if the [NILETTER] is 'X', 'C', or 'W'. Please check</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.EMPLOYEESCONTRIBUTIONSONALLEARNINGS.1">The amount in [EMPLOYEESCONTRIBUTIONSONALLEARNINGS] must be 0.00 if the [NILETTER] is 'X', 'C', or 'W'. Please check</sch:diagnostic>
    <sch:diagnostic id="errorCode.EMPLOYEESCONTRIBUTIONSONALLEARNINGSYEARTODATE.1">7866</sch:diagnostic>
    <sch:diagnostic id="transactional.EMPLOYEESCONTRIBUTIONSONALLEARNINGSYEARTODATE.1">The amount in [EMPLOYEESCONTRIBUTIONSONALLEARNINGSYEARTODATE] must be 0.00 if the [NILETTER] is 'X', 'C', or 'W'. Please check</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.EMPLOYEESCONTRIBUTIONSONALLEARNINGSYEARTODATE.1">The amount in [EMPLOYEESCONTRIBUTIONSONALLEARNINGSYEARTODATE] must be 0.00 if the [NILETTER] is 'X', 'C', or 'W'. Please check</sch:diagnostic>
