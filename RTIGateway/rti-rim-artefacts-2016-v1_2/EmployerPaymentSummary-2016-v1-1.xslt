...
<dsl-rim:namespaceMappings xmlns:dsl-rim="http://www.decisionsoft.com/rim" xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse">
    ...
    <dsl-rim:namespaceMapping prefix="eps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/EmployerPaymentSummary/15-16/1"/>
...
<!--PATTERN p58-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RecoverableAmountsYTD/eps:TaxMonth" mode="M13" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('1' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-03-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-05-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('2' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-04-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-06-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('3' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-05-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-07-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('4' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-06-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-08-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('5' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-07-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-09-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('6' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-08-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-10-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('7' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-09-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-11-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('8' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-10-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, '-12-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('9' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-11-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016, '-01-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('10' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016 - 1, '-12-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016, '-02-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('11' = (.))               or             (               (round(date:seconds(normalize-space(concat(2016, '-01-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))                 and               (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016, '-03-19'))) div 86400))             )"/>
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="not('12' = (.))               or             (round(date:seconds(normalize-space(concat(2016, '-02-06'))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))"/>
      <axsl:otherwise>
...
<!--PATTERN p57-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RecoverableAmountsYTD" mode="M14" priority="4000">

		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="eps:SMPRecovered or            eps:SPPRecovered or            eps:SAPRecovered or            eps:ShPPRecovered or            eps:NICCompensationOnSMP or            eps:NICCompensationOnSPP or            eps:NICCompensationOnSAP or            eps:NICCompensationOnShPP or            eps:CISDeductionsSuffered"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7912</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">There must be an entry in at least one of [SMPRECOVERED], [SPPRECOVERED], [SAPRECOVERED], [SHPPRECOVERED], [NICCOMPENSATIONONSMP], [NICCOMPENSATIONONSPP], [NICCOMPENSATIONONSAP], [NICCOMPENSATIONONSHPP] or [CISDEDUCTIONSSUFFERED] if [RECOVERABLEAMOUNTSYEARTODATE] is present. Please check.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>If [RECOVERABLEAMOUNTSYEARTODATE] is present, at least one of [SMPRECOVERED] or [SPPRECOVERED] or [SAPRECOVERED] or [SHPPRECOVERED] or [NICCOMPENSATIONONSMP] or [NICCOMPENSATIONONSPP] or [NICCOMPENSATIONONSAP] or [NICCOMPENSATIONONSHPP] or [CISDEDUCTIONSSUFFERED] must be present.</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
...
<!--PATTERN p59-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RelatedTaxYear" mode="M15" priority="4000">
...
<!--PATTERN p60-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:FinalSubmission/eps:BecauseSchemeCeased" mode="M16" priority="4000">
...
<!--PATTERN p61-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:FinalSubmission/eps:DateSchemeCeased" mode="M17" priority="4000">
...
<!--PATTERN p49-->
	...
	<!--RULE -->
<axsl:template match="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary" mode="M18" priority="4000">
...
<axsl:choose>
      ...
      <axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose>
      <axsl:when test="eps:NoPaymentForPeriod or eps:PeriodOfInactivity or eps:EmpAllceInd or eps:RecoverableAmountsYTD or eps:Account or eps:QuestionsAndDeclarations"/>
      <axsl:otherwise>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="errorCode">7913</axsl:variable>
        <axsl:variable xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" name="defaultMessage">On an Employer Payment Submission there must be an entry in at least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [ACCOUNTINFORMATION] or [QUESTIONSANDDECLARATIONS]. Please check.</axsl:variable>
        <err:Error xmlns:err="http://www.govtalk.gov.uk/CM/errorresponse" xmlns:dsl="http://decisionsoft.com/rim/errorExtension">
          <err:RaisedBy>ChRIS</err:RaisedBy>
          <err:Number>
            <axsl:value-of select="normalize-space($errorCode)"/>
          ...
          <err:Text>
            <axsl:choose>
              ...
              <axsl:otherwise>On an EPS, at least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [ACCOUNTINFORMATION] or [QUESTIONSANDDECLARATIONS] must be submitted.</axsl:otherwise>
            </axsl:choose>
          </err:Text>
          <err:Location>
            <axsl:apply-templates mode="schematron-get-full-path" select="."/>
