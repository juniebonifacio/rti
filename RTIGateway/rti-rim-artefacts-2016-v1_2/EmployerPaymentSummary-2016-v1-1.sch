...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="exslt">
  ...
  <sch:ns prefix="eps" uri="http://www.govtalk.gov.uk/taxation/PAYE/RTI/EmployerPaymentSummary/15-16/1"/>
    <sch:pattern id="p48">
    ...
    <sch:pattern id="p58">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary/eps:RecoverableAmountsYTD/eps:TaxMonth">
        <sch:assert test="not(&apos;1&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-03-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-05-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;2&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-04-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-06-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;3&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-05-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-07-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;4&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-06-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-08-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;5&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-07-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-09-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;6&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-08-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-10-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;7&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-09-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-11-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;8&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-10-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016 - 1, &apos;-12-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;9&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-11-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016, &apos;-01-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;10&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016 - 1, &apos;-12-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016, &apos;-02-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;11&apos; = (.))
              or
            (
              (round(date:seconds(normalize-space(concat(2016, &apos;-01-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))
                and
              (round(date:seconds(normalize-space(date:date())) div 86400) &lt;= round(date:seconds(normalize-space(concat(2016, &apos;-03-19&apos;))) div 86400))
        ...
        <sch:assert test="not(&apos;12&apos; = (.))
              or
            (round(date:seconds(normalize-space(concat(2016, &apos;-02-06&apos;))) div 86400) &lt;= round(date:seconds(normalize-space(date:date())) div 86400))" id="a_TAXMONTH.12" diagnostics="errorCode.TAXMONTH.12 transactional.TAXMONTH.12 transactional.en.TAXMONTH.12 ">A [TAXMONTH] equal to 12 is only valid if the submission is made on or after 6 February of [RELATEDTAXYEAR].</sch:assert>
      </sch:rule>
    </sch:pattern>
    <sch:pattern id="p57">
    ...
    <sch:pattern id="p49">
      <sch:rule context="/hd:GovTalkMessage/hd:Body/eps:IRenvelope/eps:EmployerPaymentSummary">
        ...
        <sch:assert test="eps:NoPaymentForPeriod or eps:PeriodOfInactivity or eps:EmpAllceInd or eps:RecoverableAmountsYTD or eps:Account or eps:QuestionsAndDeclarations" id="a_EPS.0" diagnostics="errorCode.EPS.0 transactional.EPS.0 transactional.en.EPS.0 ">On an EPS, at least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [ACCOUNTINFORMATION] or [QUESTIONSANDDECLARATIONS] must be submitted.</sch:assert>
      </sch:rule>
    </sch:pattern>
  <sch:diagnostics>
    ...
    <sch:diagnostic id="transactional.EPS.0">On an Employer Payment Submission there must be an entry in at least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [ACCOUNTINFORMATION] or [QUESTIONSANDDECLARATIONS]. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.EPS.0">On an Employer Payment Submission there must be an entry in at least one of [NOPAYMENTFORPERIOD], [PERIODOFINACTIVITY], [EMPLOYMENTALLOWANCEINDICATOR], [RECOVERABLEAMOUNTSYEARTODATE], [ACCOUNTINFORMATION] or [QUESTIONSANDDECLARATIONS]. Please check.</sch:diagnostic>
    ...
    <sch:diagnostic id="transactional.PAYMENTFORPERIOD.0">There must be an entry in at least one of [SMPRECOVERED], [SPPRECOVERED], [SAPRECOVERED], [SHPPRECOVERED], [NICCOMPENSATIONONSMP], [NICCOMPENSATIONONSPP], [NICCOMPENSATIONONSAP], [NICCOMPENSATIONONSHPP] or [CISDEDUCTIONSSUFFERED] if [RECOVERABLEAMOUNTSYEARTODATE] is present. Please check.</sch:diagnostic>
    <sch:diagnostic xml:lang="en" id="transactional.en.PAYMENTFORPERIOD.0">There must be an entry in at least one of [SMPRECOVERED], [SPPRECOVERED], [SAPRECOVERED], [SHPPRECOVERED], [NICCOMPENSATIONONSMP], [NICCOMPENSATIONONSPP], [NICCOMPENSATIONONSAP], [NICCOMPENSATIONONSHPP] or [CISDEDUCTIONSSUFFERED] if [RECOVERABLEAMOUNTSYEARTODATE] is present. Please check.</sch:diagnostic>
